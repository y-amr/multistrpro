...
def start_stream():
    ...
    if stream_id and stream_duration:
        ...
        process = subprocess.Popen(f'ffmpeg -stream_loop -1 -re -i /root/flask_app/movie.mp4 -stream_loop -1 -i /root/flask_app/music.mp3 -c:v libx264 -preset veryfast -b:v 3000k -maxrate 3000k -bufsize 6000k -pix_fmt yuv420p -g 50 -c:a aac -b:a 160k -ac 2 -ar 44100 -f flv "rtmp://live.twitch.tv/app/{stream_id}"', shell=True)
